# Cartes agent Zenith — Vénus (orange)
...
### Hiroshi Sun  (scan 22.44_5, coût 1, peuple Humain)
...
### GERONIMO  (scan 22.44_12, coût 2, peuple Animod)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### LUC4S  (scan 22.44_17, coût 2, peuple Robot)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### AS1MØV  (scan 22.44_23, coût 10, peuple Robot)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### C1X1N  (scan 22.44_24, coût 4, peuple Robot)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
| 2 | CONDITION : si je possède le badge Leader (argent ou or) → +1 influence sur Vénus | FACUL | ✓ | |

---

### FELIS  (scan 22.44_25, coût 3, peuple Animod)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### Moussa  (scan 23.02_8, coût 2, peuple Animod)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
| 2 | Échelle : dépenser 1x/2x/3x zénithium → chevron ▶ → gagner 4x/8x/12x crédits (ratio constant 1 zénithium = 4 crédits) | FACUL | ✓ | |

---

### V4N VØGT  (scan 23.02_12, coût 6, peuple Robot)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### Stessy Power  (scan 23.02_28, coût 3, peuple Humain)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### BR4DBURY  (scan 23.02_29, coût 6, peuple Robot)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### Doc Wissen  (scan 23.02_30, coût 6, peuple Humain)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### CRESUS  (scan 23.02_31, coût 1, peuple Animod)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
| 2 | Gagner 6 crédits | OBLIG | ✓ | |

---

### PACHACUTI  (scan 23.02_32, coût 3, peuple Animod)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### Ilda Flores  (scan 23.02_33, coût 1, peuple Humain)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### Professor Zed  (scan 23.02_35, coût 9, peuple Humain)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
| 2 | Gagner 4 zénithium | OBLIG | ✓ | |

---

### King Harold  (scan 23.02_37, coût 6, peuple Humain)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### BUJØLD  (scan 23.02_52, coût 7, peuple Robot)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
### ARCHIMEDES  (scan 23.02_58, coût 6, peuple Animod)
| # | Effet décodé | Type | Conf. | Réel (à confirmer/corriger) |
|---|---|---|---|---|
| 1 | +1 influence sur Vénus | OBLIG | ✓ | |
...
## Récapitulatif — 18 cartes Vénus
Hiroshi Sun, Geronimo, Luc4s, As1møv, C1x1n, Felis, Moussa, V4n Vøgt, Stessy Power, Br4dbury, Doc Wissen, Cresus, Pachacuti, Ilda Flores, Professor Zed, King Harold, Bujøld, Archimedes.

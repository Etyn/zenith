...
import { PLANETS, type PlayerView } from '../../engine';
 ...
 * gauche → droite). Chaque colonne : barre + points de niveau, disque coloré mobile
  ...
  return (
    <View className="flex-row justify-between bg-slate-900/40 rounded-2xl px-2 py-3">
      {PLANETS.map((planet) => {
        ...
        return (
          <View key={planet} className="flex-1 items-center">
            <View style={{ width: '100%', height: TRACK_HEIGHT, position: 'relative' }}>
              ...
              <View
                style={{
                  ...
                  top: centerY(displayPos) - DISC_SIZE / 2,
                  width: DISC_SIZE,
                  height: DISC_SIZE,
